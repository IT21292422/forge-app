...
export default function Testimonial() {
    return (
        <>
            <div className="bg-cover bg-center mt-20" style={{ backgroundImage: 'url("testimonial.jpg")' }}>
                <div>
                    <h1 className="text-3xl text-center font-prata leading-[50px] pt-10">Student's Testimonials</h1>
                    <h1 className="text-md text-center text-gray-400 mb-16">What our Students say</h1>
                    <div className="flex flex-wrap gap-10 justify-center pb-10">
                        ...
                        <div className="card bg-base-100 w-[590px] rounded-2xl flex-row p-10">
                            ...
                            <div className="relative ml-5 z-10">
                                <p className="text-gray-500 mb-3 text-sm">"You made it so simple. I was able to learn React in less than a month. I really love Courzinger"</p>
                                <p className="font-prata ">Leslie Alexander</p>
                                <p className="text-gray-500 text-sm">Freelance React Developer</p>
                            </div>
                        ...
                        <div className="card bg-base-100 w-[590px] rounded-2xl flex-row p-10">
                            ...
                            <div className="relative ml-5 z-10">
                                <p className="text-gray-500 mb-3 text-sm">"As always a 5 star! Simply the best. Better than all the rest. I'd recommend this to beginners and advanced users."</p>
                                <p className="font-prata ">Jacob Jones</p>
